...
const ProfessionalsManager: React.FC = () => {
  ...
  const fetchProfessionals = async () => {
    try { setIsLoading(true); const data = await getProfessionals(); setProfessionals(data); } catch { setError('No se pudieron cargar los profesionales.'); } finally { setIsLoading(false); }
  };
